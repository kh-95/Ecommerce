...
<nav class="navbar navbar-area navbar-expand-lg navbar-light bg-orange">
        <div class="container nav-container">
            <div class="logo-wrapper navbar-brand ">
                <a href="/user/index.html" class="logo main-logo mobile-logo">
            ...
            <div class="collapse navbar-collapse" id="mirex">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active dropdown">
                        <a class="nav-link pl-0 dropdown-toggle" href="#">Home
                            <span class="sr-only">(current)</span>
                        </a>
                        <div class="dropdown-menu">
                            <a href="/userindex.html" class="dropdown-item">Home Style 01</a>
                            <a href="index-2.html" class="dropdown-item">Home Style 02</a>
                            <a href="/user/index-3.html" class="dropdown-item">Home Style 03</a>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-3 col-sm-12">
                                        <a href="product-details.html">
                                            <img src="/user/assets/img/mega-menu.jpg" alt="product image">
                                        </a>
                                  </div>
                                </div>
                              </div>
